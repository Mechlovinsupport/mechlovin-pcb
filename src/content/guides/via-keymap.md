...
lede: VIA lets you remap any key on your Mechlovin PCB in real time. Changes
  save straight to the board and travel with it between computers. This guide
  covers connecting your board, remapping keys, working with layers, and backing
  up your layout.
tag: Keymapping
order: 2
